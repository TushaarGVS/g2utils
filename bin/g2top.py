...
if __name__ == "__main__":
    ...
    if args.disp_users:
        print(
            f"{'Server':25}   {'NetID':^9}   {'Partition':^17}   {'GPU':^19}{'CPU usage':^12}\t{'GPU usage':9}\tMem GB (in-use / down / avail)")
    else:
        print(f"{'Server':25}{'GPU':19}{'CPU usage':^12}\t{'GPU usage':9}\tMem GB (in-use / down / avail)")
